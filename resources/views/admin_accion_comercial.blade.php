                            ...
                            <tbody>
                              @foreach ($acc_com as $acc)
                                  <tr>
                                      ...
                                      <td>
                                          <button class="btn btn-secondary" data-toggle="modal" data-target='#eliminarAcc{{$acc->pre_id}}' tabindex="0" aria-controls="copy-print-csv" type="button" value="Eliminar"  style="margin-bottom: 10px; margin-right: 10px;">Eliminar</button>
                                          <a href="{{url('/modificarAccCom/'.$acc->pre_id)}}"><button class="btn btn-warning" tabindex="0" aria-controls="copy-print-csv" type="button" value="Modificar" style="margin-bottom: 10px">Modificar</button></a>
