			...
			<nav class="navbar navbar-expand-lg custom-navbar">
				...
				<div class="collapse navbar-collapse" id="WafiAdminNavbar">
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
							<a class="nav-link active-page dropdown-toggle" href="#" id="formsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i class="icon-edit1 nav-icon"></i>
								Forms
							</a>
							<ul class="dropdown-menu" aria-labelledby="formsDropdown">
								<li>
									<a class="dropdown-item active-page" href="wizard.html">Wizards</a>
								</li>
								<li>
