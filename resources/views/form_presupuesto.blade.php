								...
								<div id="example-form">
										...
										<div class="row gutters">
												...
												<div class="form-group">
													...
													<select class="form-control" id='razon_social' name="razon_social" onchange="actualizarsociedad()">
														...
														@foreach ($sociedades as $sociedad)
                                                            ...
                                                            @if (isset($mod_pre) AND $sociedad->id === $razon_social->id)
                                                                <option value="{{$sociedad->id}}" selected>{{$sociedad->soc_nom}}</option>
                                                            @else
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" id="emisora" name="emisora" placeholder="Introduzca la emisora" value="{{$emisora}}">
                                                    @else
                                                        <input type="text" class="form-control" id="emisora" name="emisora" placeholder="Introduzca la emisora">
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text"  class="form-control" name="sociedad_cif" id="sociedad_cif" readonly value="{{$razon_social->sociedades->soc_cif}}">
                                                    @else
                                                        <input type="text"  class="form-control" name="sociedad_cif" id="sociedad_cif" readonly>
                                                    @endif
                                                    <input type="text"  class="form-control" name="sociedad_nom" id="sociedad_nombre" readonly style="display:none" >
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" name="sociedad_direccion" id="sociedad_direccion"  readonly value="{{$razon_social->sociedades->soc_dir}}">
                                                    @else
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="number" class="form-control" name="sociedad_cp" id="sociedad_cp"  readonly value="{{$razon_social->sociedades->soc_cp}}">
                                                    @else
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" id="sociedad_provincia" name="sociedad_provincia" readonly value="{{$razon_social->sociedades->soc_pro}}">
                                                    @else
									...
									<section>
										<div class="row gutters">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                                <div class="form-group">
													<label for="fullName">Anunciante</label>
                                                    @if (isset($mod_pre) )
                                                        <input list="brow" autocomplete="off" id="cliente_anunciante" class="form-control" placeholder="Introduzca el nombre del cliente" name="cliente_anunciante" onchange="Rellenar()" value="{{$cliente_objetivo->clientes->cli_anu}}">
                                                    @else
                                                        <input list="brow" autocomplete="off" id="cliente_anunciante" class="form-control" placeholder="Introduzca el nombre del cliente" name="cliente_anunciante" onchange="Rellenar()">
                                                    @endif
                                                    <datalist id="brow" >
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input class="form-control" placeholder="Sin Datos" id="cliente_razon_social" name="cliente_razon_social" readonly value="{{$cliente_objetivo->clientes->cli_nom}}">
                                                    @else
                                                        <input class="form-control" placeholder="Sin Datos" id="cliente_razon_social" name="cliente_razon_social" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
													<label for="cliente_cif">NIF/CIF</label>
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" id="cliente_cif" name="cliente_cif" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_cif}}">
                                                    @else
                                                        <input type="text" class="form-control" id="cliente_cif" name="cliente_cif" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" id="cliente_domicilio" name="cliente_domicilio" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_dir}}">
                                                    @else
                                                        <input type="text" class="form-control" id="cliente_domicilio" name="cliente_domicilio" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" id="cliente_provincia" name="cliente_provincia" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_pro}}">
                                                    @else
                                                        <input type="text" class="form-control" id="cliente_provincia" name="cliente_provincia" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="number" class="form-control" id="cliente_cp" name="cliente_cp" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_cp}}">
                                                    @else
                                                        <input type="number" class="form-control" id="cliente_cp" name="cliente_cp" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" id="cliente_poblacion" name="cliente_poblacion" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_loc}}">
                                                    @else
                                                        <input type="text" class="form-control" id="cliente_poblacion" name="cliente_poblacion" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="number" class="form-control" id="cliente_telefono1" name="cliente_telefono1" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_tel1}}">
                                                    @else
                                                        <input type="number" class="form-control" id="cliente_telefono1" name="cliente_telefono1" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="number" class="form-control" id="cliente_telefono2" name="cliente_telefono2" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_tel2}}">
                                                    @else
                                                        <input type="number" class="form-control" id="cliente_telefono2" name="cliente_telefono2" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="mail" class="form-control" id="cliente_mail1" name="cliente_mail1" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_mail1}}">
                                                    @else
                                                        <input type="mail" class="form-control" id="cliente_mail1" name="cliente_mail1" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="mail" class="form-control" id="cliente_mail2" name="cliente_mail2" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_mail2}}">
                                                    @else
                                                        <input type="mail" class="form-control" id="cliente_mail2" name="cliente_mail2" placeholder="Sin Datos" readonly>
                                                    @endif
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($mod_pre))
                                                        <input type="text" class="form-control" id="cliente_contacto" name="cliente_contacto" placeholder="Sin Datos" readonly value="{{$cliente_objetivo->clientes->cli_cont_nom}}">
                                                    @else
                                                        <input type="text" class="form-control" id="cliente_contacto" name="cliente_contacto" placeholder="Sin Datos" readonly>
                                                    @endif
										...
										<div class="row gutters">
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
													...
													<div class="dropdown bootstrap-select form-control">
                                                        @if (isset($cliente_objetivo))
                                                            @if ( isset($cliente_objetivo->clientes->metodos_pago->met_pago_desc))
                                                                <input list="listPago" id="formPago" class="form-control" placeholder="Introduzca el método de pago" name="formPago" onchange="validar_pago()" value="{{$cliente_objetivo->clientes->metodos_pago->met_pago_desc}}" readonly>
                                                            @else
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($cliente_objetivo))
                                                        @if ($cliente_objetivo->clientes->cli_iban != NULL)
                                                            <input type="text" class="form-control" id="iban" name="iban" placeholder="Introduzca el IBAN" onchange="validar_pago()" required value="{{$cliente_objetivo->clientes->cli_iban}}" readonly>
                                                        @else
											...
											<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
												<div class="form-group">
                                                    ...
                                                    @if (isset($cliente_objetivo))
                                                        @if ($cliente_objetivo->clientes->cli_obs_pago != NULL)
                                                            <textarea id="observaciones_pago" name="observaciones_pago" rows="6" cols="80">{{$cliente_objetivo->clientes->cli_obs_pago}}</textarea>
                                                        @else
										...
										<div class="row gutters">
											<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
												<div class="form-group">
                                                    ...
                                                    @if(isset($mod_pre))
                                                        @if(isset($accion_vigente))
                                                            <h4>{{$accion_vigente->acc_com_name}} - {{$accion_vigente->acc_com_tipo}}</h4>
                                                            <input type="number" name="accion_comercial_id" value="{{$accion_vigente->pre_id}}" style="display:none">
                                                        @endif
                                                    @else
											...
											<div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
												<div class="form-group">
													...
													@if (isset($mod_pre))
														<input type="number" onchange="modificarDescuento(); calcularDescuento()" class="form-control" id="factAnual" name="factAnual" value="{{$mod_pre[0]->pre_fact_anu}}" placeholder="Introduzca su facturación anual" min="0">
													@else
														<input type="number" onchange="modificarDescuento(); calcularDescuento()" class="form-control" id="factAnual" name="factAnual" placeholder="Introduzca su facturación anual" min="0">
													@endif
											...
											<div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
												<div class="form-group">
													...
													@if (isset($mod_pre))
														<input type="number" onchange="modificarDescuento(); calcularDescuento()" class="form-control" id="antig" name="antig" value="{{$mod_pre[0]->pre_antig}}" placeholder="Introduzca la antigüedad" min="0">
													@else
														<input type="number" onchange="modificarDescuento(); calcularDescuento()" class="form-control" id="antig" name="antig" placeholder="Introduzca la antigüedad" min="0">
													@endif
											...
											<div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
												<div class="form-group">
													...
													<div class="custom-control custom-switch">
														<input type="checkbox" onchange="modificarDescuento(); calcularDescuento()" class="custom-control-input" id="prontoPago" name="prontoPago">
											...
											<div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
												<div class="form-group">
													<div class="form-group">
														...
														<input type="text" onchange="calcularDescuento()" class="form-control" id="observ" name="observ" max="50">
													</div>
												</div>
											</div>
											...
											@if (isset($cont) AND !isset($nueva_copia))
											...
											@if (isset($mod_pre) AND !isset($nueva_copia))
												<input type="number" class="form-control" style="display: none;" name="mod_id" id="mod_id" value="{{$mod_pre[0]->pre_id}}">
                                                <input type="number" style="display:none" name="controlador_pago" id="controlador_pago" value="{{$mod_pre[0]->pre_pago_valido}}">
											@endif
                                            @if (isset($nueva_copia))
                                                <input type="number" class="form-control" style="display: none;" name="nueva_copia" id="nueva_copia" value="{{$nueva_copia}}">
                                            @endif
                                            ...
                                            <input type="text" name="pago_valido" id="pago_valido" value="0" style="display:none">
											...
											<div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
												<div class="form-group">
													...
													<input type="number" onchange="calcularDescuento();" class="form-control" id="ncu" placeholder="Introduzca el número de cuñas">
											...
											<div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
												<div class="form-group">
													...
													<select class="form-control" onchange="calcularDescuento();" title="Seleccione una duración" tabindex="-98" id="dur">
											...
											<div class="col-xl-12 col-lg col-md-12 col-sm-12 col-12">
												...
												<button type="button" id="add_button" class="btn btn-primary" style="left: 47.5%; position: relative; margin-bottom: 10px" onclick="add_linea()">Añadir</button>
															...
															<div class="modal-content">
																...
																<div class="modal-body">
																	<div id="contadores{{$consulta->sop_pre_id}}">
																		@if (isset($mod_lin) AND !isset($nueva_copia))
																	...
																	<div class="table-responsive">
																		<table class="table table-bordered">
																			...
																			<tbody id="opt_tabla{{$consulta->sop_pre_id}}">
																				@if (isset($mod_opt) AND !isset($nueva_copia))
																...
																@if (isset($mod_lin) AND !isset($nueva_copia))
																	@foreach ($mod_lin as $mod_linea)
																		<tr class='filasTabla' id="fila{{$mod_linea->lin_pre_lin}}">
																			...
																			<td><img onclick='editar({{$mod_linea->lin_pre_lin}},{{$mod_linea->lin_pre_sop}})' class='icono_opciones edit_line' style='margin-right:30px' src='/assets/img/lapiz.png' width='30px' height='30px' alt='Modificar Linea' title='Modificar Linea'>
																				...
																				<img onclick='cambiarTarget({{$mod_linea->lin_pre_lin}},{{$mod_linea->lin_pre_sop}})' class='icono_opciones edit_line' data-toggle='modal' data-target='#basicModal' src='/assets/img/cubo.png' width='30px' height='30px' alt='Eliminar Linea' title='Eliminar Linea'>
																			</td>
