              ...
              <div class="card-body">
                <div class="customScroll5">
                  <div class="top-agents-container">
                    <div class="top-agent">
                      <img src="{{asset('assets/img/user.png')}}" class="avatar" alt="Agent" />
                    ...
                    <div class="top-agent">
                      <img src="{{asset('assets/img/user22.png')}}" class="avatar" alt="Agent" />
                      <div class="agent-details">
                        <h6>Lily Jordan</h6>
                        <div class="agent-score">
                          <div class="progress">
                    ...
                    <div class="top-agent">
                      <img src="{{asset('assets/img/user6.png')}}" class="avatar" alt="Agent" />
                      <div class="agent-details">
                        <h6>Ali Sayed</h6>
                        <div class="agent-score">
                          <div class="progress">
                    ...
                    <div class="top-agent">
                      <img src="{{asset('assets/img/user20.png')}}" class="avatar" alt="Agent" />
                      <div class="agent-details">
                        <h6>Aaleyah Malik</h6>
                        <div class="agent-score">
                          <div class="progress">
                    ...
                    <div class="top-agent">
                      <img src="{{asset('assets/img/user13.png')}}" class="avatar" alt="Agent" />
                      <div class="agent-details">
                        <h6>Aabid Raheem</h6>
                        <div class="agent-score">
                          <div class="progress">
